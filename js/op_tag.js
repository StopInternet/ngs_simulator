const tag_op = {
    ...
    //スタロ
    Staro_Soul:{name:"スタロ・ソール(予想)",level:1,value:13},
    ...
    FomidoFusia:{name:"フォミド・フュージア",level:2,value:6},
    DelieraFusia:{name:"ディエラ・フュージア(予想）",level:3,value:8},
    ...
    DefiHaumes_p2:{name:"デフィ・エリシスP.02(予想)",level:1,value:8},
    DefiMakemes_p2:{name:"デフィ・セイレスP.02(予想)",level:1,value:8},
    DefiPlutos_p2:{name:"デフィ・プルトスP.02(予想)",level:1,value:8},
    DefiCeires_p2:{name:"デフィ・マケメスP.02(予想)",level:1,value:8},
    ...
    Ritemu_Sbrina:{name:"リテム・ソブリナ(予想)",level:1,value:13},
    Kuvaru_Sbrina:{name:"クヴァル・ソブリナ(予想)",level:1,value:13},
    Stia_Sbrina:{name:"スティラ・ソブリナ(予想)",level:1,value:13},
}
